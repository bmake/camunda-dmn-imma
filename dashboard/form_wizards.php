              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Studierende <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Anzeigen</a></li>
                      <li><a href="form_advanced.html">Bearbeiten <span class="label label-success pull-right">Coming Soon</span></a></li>
                      <!--<li><a href="form_validation.html">Form Validation</a></li>-->
                      <li><a href="form_wizards.html">Hinzufügen</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="login.html"><i class="fa fa-sign-out pull-right"></i> Abmelden</a></li>
                  </ul>
                </li>
...
$nachricht = "Sehr geehrter Studierender, 
vielen Dank für Ihre Bewerbung. Sie sind jetzt immatrikuliert. 
Folgende Unterlagen
        ";
...
echo $nachricht;
echo $ausgabe;
echo '"><button>Student per E-Mail benachrichtigen</button></a>';
...
php?>
                      ...
                      <div id="step-2">
                        ...
                        <p>
                          Bitte tragen Sie hier die persönlichen Daten des Studierenden ein.
                        </p>
                        <p>
                      ...
                      <div id="step-3">
                        <h2 class="StepTitle">3. Schritt</h2>
                        <p>
                      ...
                      <div id="step-4">
                        <h2 class="StepTitle">4. Schritt</h2>
